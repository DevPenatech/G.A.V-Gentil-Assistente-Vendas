...
FERRAMENTAS: get_top_selling_products, get_top_selling_products_by_name, add_item_to_cart, view_cart, atualizar_item_carrinho, checkout, lidar_conversa, ask_continue_or_checkout, clear_cart
